...
const Movielist = () => {
    return (
        <div className="container">
            ...
            <Card src={goblin}title="Goblin" description="Make a wish with Goblin" link="https://mydramalist.com/18452-goblin"/>
            <Card src={glory}title="The Glory" description="A revenge drama that you don't want to miss" link="https://mydramalist.com/685237-untitled-kim-eun-sook-project" />
